...
function M.invert(color)
	...
	elseif type(color) == "string" then
		local hsluv = require("cryo_themes.hsluv")
		if color ~= "NONE" then
...
---@param groups cryo_themes.Highlights
...
function M.cache.file(key)
	return vim.fn.stdpath("cache") .. "/cryo_themes-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
	---@type boolean, cryo_themes.Cache
...
function M.cache.clear()
	local pattern = vim.fn.stdpath("cache") .. "/cryo_themes-*.json"
