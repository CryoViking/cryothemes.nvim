...
---@class cryo_themes.Config
---@field on_colors fun(colors: ColorScheme)
---@field on_highlights fun(highlights: cryo_themes.Highlights, colors: ColorScheme)
M.defaults = {
	...
	---@param highlights cryo_themes.Highlights
	---@param colors ColorScheme
...
---@type cryo_themes.Config
M.options = nil

---@param options? cryo_themes.Config
