...
---@type table<string, Palette|fun(opts:fallout4_improved.Config):Palette>
M.styles = setmetatable({}, {
	__index = function(_, style)
		return vim.deepcopy(util.mod("fallout4_improved.colors." .. style))
	end,
})
