local util = require("fallout4_improved.util")
...
function M.get(c, opts)
  ...
  return {
    ...
    Character                   = { fg = c.string_fg}, --  a character constant: 'c', '\n'
    ...
    String                      = { fg = c.string_fg }, -- a string constant: "this is a string"
    Todo                        = { fg = c.todo_fg }, -- (preferred) anything that needs extra attention; mostly the keywords TODO FIXME and XXX
