...
---@class fallout4_improved.Config
---@field on_colors fun(colors: ColorScheme)
---@field on_highlights fun(highlights: fallout4_improved.Highlights, colors: ColorScheme)
M.defaults = {
	style = "fallout4_default",
	transparent = false,
	...
	---@param highlights fallout4_improved.Highlights
	---@param colors ColorScheme
...
---@type fallout4_improved.Config
M.options = nil

---@param options? fallout4_improved.Config
